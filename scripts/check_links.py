...
REQUIRED_DEEP_LINKS = {
    ...
    "/landscape/works/glm-5-architecture/": {
        "model-ledger",
        "muon-split",
        "shared-mtp",
        "dsa-continued-pretraining",
        "efficient-attention-ablation",
    },
    "/landscape/works/indexcache/": {
        "indexcache-state",
        "cross-layer-overlap",
        "training-free-greedy",
        "multi-layer-distillation",
        "indexshare",
        "kv-cache-boundary",
    },
    "/landscape/works/slime-async-agentic-rl/": {
        "tito",
        "direct-is",
        "zero-objective",
        "orchestrator",
    ...
    "/landscape/works/glm-agentic-engineering/": {
        "environment-loop",
        "terminal-synthesis",
        "search-data",
        "context-management",
    ...
    "/landscape/glm-5-reference-map/": {"main-chain", "reference"},
