...
REQUIRED_CLUSTERS = {
    ...
    "lineages": {
        ...
        "landscape/families/index.md",
        "landscape/families/deepseek.md",
        "landscape/families/kimi.md",
        "landscape/families/glm.md",
...
REQUIRED_EDGES = {
    ...
    "landscape/families/kimi.md": {
        "landscape/kimi-timeline.md",
        "landscape/kimi-k3-reference-map.md",
        "landscape/works/kimi-k1-5.md",
        "landscape/works/kimi-k2.md",
        "landscape/works/kimi-k2-5.md",
        "landscape/works/kimi-k3.md",
        "landscape/works/kimi-linear-flashkda.md",
        "landscape/works/attention-residuals.md",
        "landscape/works/latentmoe-quantile-balancing.md",
    ...
    "architecture/index.md": FAMILY_PORTALS,
    "data/index.md": FAMILY_PORTALS,
    "training/index.md": FAMILY_PORTALS,
    "systems/index.md": FAMILY_PORTALS,
    "inference/index.md": FAMILY_PORTALS,
    "reasoning/index.md": FAMILY_PORTALS,
    "agentic-rl/index.md": FAMILY_PORTALS,
    "applications/index.md": FAMILY_PORTALS,
    "evaluation/index.md": FAMILY_PORTALS,
    "multimodal/index.md": {
        "multimodal/history.md",
        "multimodal/foundations/signals-tokenization.md",
        "multimodal/foundations/alignment-fusion.md",
