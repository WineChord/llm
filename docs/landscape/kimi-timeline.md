...
Kimi 家族不是一条只按参数量递增的直线。K1.5 把长上下文强化学习推到前台，Kimi-VL 建立视觉分支，K2 把稀疏模型与 agentic post-training 结合，Kimi Linear 改写长序列的信息通路，K2.5 让视觉、thinking 与 agent 共同训练，Attention Residuals 又把寻址能力从 token 轴延伸到 depth 轴。K3 才把这些路线汇合成同一个 2.8T 级系统。
...
| --- | --- | --- | --- | --- | --- |
| Kimi k1.5 | [2025-01-22，arXiv:2501.12599](https://arxiv.org/abs/2501.12599) | 未随官方报告仓库发布 | 仓库只有报告、README 与图片 | 论文不能证明某个同名线上服务等同于该 checkpoint | 官方仓库没有模型许可证文件 |
| Kimi-VL | [2025-04-10，arXiv:2504.07491](https://arxiv.org/abs/2504.07491) | [A3B-Instruct](https://huggingface.co/moonshotai/Kimi-VL-A3B-Instruct) 与后续 Thinking 版本 | [官方仓库](https://github.com/MoonshotAI/Kimi-VL)含使用入口，不等于完整训练栈 | 官方曾提供体验入口；具体线上版本应单独核验 | [MIT](https://github.com/MoonshotAI/Kimi-VL/blob/main/LICENSE) |
| Kimi K2 | [2025-07-28，arXiv:2507.20534](https://arxiv.org/abs/2507.20534) | [K2-Instruct](https://huggingface.co/moonshotai/Kimi-K2-Instruct)；报告也区分 Base / Instruct | [报告仓库](https://github.com/MoonshotAI/Kimi-K2)与推理适配；训练配方未完整开放 | API / 产品是独立发布面，不能由 arXiv 日期倒推 | [Modified MIT](https://github.com/MoonshotAI/Kimi-K2/blob/main/LICENSE) |
...
| Kimi K2.5 | [2026-02-02，arXiv:2602.02276](https://arxiv.org/abs/2602.02276) | [K2.5](https://huggingface.co/moonshotai/Kimi-K2.5) | [报告与部署资料](https://github.com/MoonshotAI/Kimi-K2.5)，未开放完整预训练和 RL 系统 | 产品中的 thinking、visual agent 与 Agent Swarm 属于线上系统层 | [Modified MIT](https://github.com/MoonshotAI/Kimi-K2.5/blob/master/LICENSE) |
...
[Kimi k1.5](https://arxiv.org/abs/2501.12599)的历史位置，不在于它给出了后来 K3 的全部优化算法，而在于它把三件事绑到了一起：
...
[Kimi-VL](https://arxiv.org/abs/2504.07491)使用稀疏视觉语言模型研究视觉编码、长文档、视频与多模态 reasoning。它与 K3 的关系主要有两层：
...
[Kimi K2](https://arxiv.org/abs/2507.20534)是 K3 最直接的 dense-to-sparse scale baseline。它公开的主线包括：
...
[Kimi K2.5](https://arxiv.org/abs/2602.02276)在 K2-Base 上继续约 15T mixed visual-text token 的 continual pretraining，并把 instant / thinking、视觉输入和 agentic execution 放入同一模型。它给 K3 留下四条直接接口：
...
- 想理解视觉分支：从[Kimi 多模态家族](../multimodal/kimi.md)进入 Kimi-VL、K2.5 与 MoonViT-V2。
