...
| 多模态 | [视觉语言](../multimodal/vision-language.md)、[融合训练](../multimodal/architecture-training.md)、[理解与生成](../multimodal/unified-understanding-generation.md) | [多模态原语](../practice/multimodal.md) | [文档与 GUI](../multimodal/document-gui-grounding.md)、[音频](../multimodal/audio-language-models.md)、[视频](../multimodal/video-world-models.md)、[多模态评测](../evaluation/multimodal-evaluation.md) |
...
| 强化学习基础 | [序贯决策](../reinforcement-learning/decision-processes.md)、[价值与 Bellman](../reinforcement-learning/values-bellman.md)、[MC 与 TD](../reinforcement-learning/prediction-control.md)、[策略优化](../reinforcement-learning/policy-gradient.md) | [强化学习](../practice/reinforcement-learning.md) | [函数逼近](../reinforcement-learning/function-approximation.md)、[探索](../reinforcement-learning/exploration-entropy.md)、[实验诊断](../reinforcement-learning/evaluation-debugging.md) |
| LLM 强化学习 | [语言模型策略](../reinforcement-learning/language-model-policy.md)、[KL 控制](../reinforcement-learning/kl-regularized-control.md)、[反馈制度](../reinforcement-learning/feedback-regimes.md)、[在线 RL](../training/online-rl.md) | [强化学习](../practice/reinforcement-learning.md)、[训练目标](../practice/training-objectives.md) | [反馈轨迹](../data/feedback-trajectories.md)、[信用分配](../reinforcement-learning/credit-assignment.md)、[RLVR](../reinforcement-learning/rlvr.md)、[统计推断](../evaluation/statistical-inference.md) |
...
| Agentic RL | [从经典 RL 到语言 Agent](../agentic-rl/rl-foundations.md)、[算法决策](../agentic-rl/math-algorithms.md)、[数据环境](../agentic-rl/data-environments.md) | [强化学习](../practice/reinforcement-learning.md)、[推理时计算](../practice/test-time-compute.md) | [轨迹契约](../agentic-rl/trajectory-contract.md)、[训练系统](../agentic-rl/training-systems.md)、[长时任务](../agentic-rl/long-horizon.md)、[评测安全](../agentic-rl/evaluation-safety.md) |
