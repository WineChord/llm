...
| 百万 token 共设计 | [DeepSeek-V4 深读](../landscape/works/deepseek-v4.md)、[DeepSeek 演化](../landscape/deepseek-timeline.md) | [CSA / HCA](../landscape/works/deepseek-compressed-attention.md)、[mHC](../landscape/works/manifold-hyper-connections.md)、[全词表 OPD](../landscape/works/on-policy-distillation.md)的页内 reference | [TileLang、MegaMoE 与 DSec](../landscape/works/tilelang-mega-moe.md)、[103 项引用图谱](../landscape/deepseek-v4-reference-map.md)与 canonical 机制页 |
| 模型—训练—系统共设计 | [Kimi K3 深读](../landscape/works/kimi-k3.md)、[Kimi 演化](../landscape/kimi-timeline.md) | KDA、AttnRes、SiTU-GLU、QB、MOPD、KCP 与 hybrid cache 的页内 reference | [150 项引用图谱](../landscape/kimi-k3-reference-map.md)、canonical 机制页与评测证据边界 |
| 稀疏注意力与 Agent 系统 | [GLM-5 深读](../landscape/works/glm-5.md)、[GLM 演化](../landscape/glm-timeline.md) | [MLA / DSA / MTP](../landscape/works/glm-5-architecture.md)、[IndexShare](../landscape/works/indexcache.md)、[TITO / direct IS](../landscape/works/slime-async-agentic-rl.md) | [Agentic Engineering](../landscape/works/glm-agentic-engineering.md)、[63 项引用图谱](../landscape/glm-5-reference-map.md)与 canonical 机制页 |
