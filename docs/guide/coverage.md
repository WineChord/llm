...
| 偏好与 RL | [奖励建模](../training/reward-modeling.md)、[离线偏好](../training/offline-preference.md)、[在线 RL](../training/online-rl.md) | [训练目标](../practice/training-objectives.md) | [反馈轨迹](../data/feedback-trajectories.md)、[策略契约](../agentic-rl/trajectory-contract.md)、[统计推断](../evaluation/statistical-inference.md) |
...
| Agentic RL | [RL 基础](../agentic-rl/rl-foundations.md)、[数学算法](../agentic-rl/math-algorithms.md)、[数据环境](../agentic-rl/data-environments.md) | [训练目标](../practice/training-objectives.md)、[推理时计算](../practice/test-time-compute.md) | [训练系统](../agentic-rl/training-systems.md)、[长时任务](../agentic-rl/long-horizon.md)、[评测安全](../agentic-rl/evaluation-safety.md) |
...
模型发布数字与机制结论分开；前者进入[模型谱系](../landscape/index.md)，后者只有在抽象后才进入机制页。
